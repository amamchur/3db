 ...
 */
#define FAN_KICKSTART_TIME  300  // (ms) //3db
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define LED_CONTROL_MENU
    ...
    //#define NEO2_COLOR_PRESETS              // Enable a second NeoPixel Preset Color menu option
      ...
      #define LED_USER_PRESET_GREEN      250  // User defined GREEN value
      #define LED_USER_PRESET_BLUE       80  // User defined BLUE value
      #define LED_USER_PRESET_WHITE      250  // User defined WHITE value
      #define LED_USER_PRESET_BRIGHTNESS 190  // User defined intensity
 ...
 */
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        // All axes (override below) //3db
