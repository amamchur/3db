...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BTT_SKR_V3_0  //3db
#endif
 ...
 */
#define X_DRIVER_TYPE  TMC2208 //3db
...
#define HEATER_0_MAXTEMP 285 //3db
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    // If there are fewer values, the last one applies to the remaining hotends.  //3db
    #define DEFAULT_Kp_LIST {  16.67,  16.67 }
    #define DEFAULT_Ki_LIST {   1.16,   1.16 }
    #define DEFAULT_Kd_LIST {  59.90,  59.90 }
  #else
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 32.71
  #define DEFAULT_bedKi 5.81
  #define DEFAULT_bedKd 122.66
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 480, 400 } //3db
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 8000, 8000, 80, 10000 }
...
#define X_BED_SIZE 120 //3db Размер стола
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 15, 15, 15, 15 } // (mm) Left, Front, Right, Back insets
